(function() {
    ...
    function proxify(url) {
        ...
        if(url.startsWith("https://www.videosprofitnetwork.com")) return url.replace("https://www.videosprofitnetwork.com", "/proxy/vpnetwork");
        else if(url.startsWith("https://cdn.cloudvideosa.com")) return url.replace("https://cdn.cloudvideosa.com", "/proxy/cloudvideocdn");
        else return url;
    }
})();