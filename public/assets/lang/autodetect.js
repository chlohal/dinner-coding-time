...
var DCT_LANG = {
    ...
    format: function (key) {
        ...
        if(value === "undefined") return "Much to our shame, this text wasn't translated properly. Please report this error.";
