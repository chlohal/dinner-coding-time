...

{
  ...
  tfpdef = n:NAME (COLON t:test)? {
      if(typeof t === "undefined") var t = null;
      return { type: "TypedArgument", typeType: t, name: n };
  }
  ...
  if_stmt = IF __ namedexpr_test COLON suite (ELIF namedexpr_test COLON suite)* (ELSE COLON suite)?
  ...
  argument = left:test compFor:comp_for? { 
                  if(compFor) return { type: "ForInArgument", arg: left, compFor: compFor };
                  else return { type: "Argument", arg: left}; } /
              left:test op:COLONEQUAL right:test { return { type: "ExpressionAssignmentDefaultValueArg", argument: left, defaultVal: right }; } /
              left:test op:EQUALS right:test { return { type: "DefaultValueArg", argument: left, defaultVal: right }; } /
              op:DOUBLE_ASTERISKS left:test { return {type: "KwVarArg", argument: left}; } /
              op:STAR left:test { return {type: "VarArg", argument: left}; }
  ...
  NUMBER
    = l:([1-9][0-9]*) {
        if(typeof l[0] === "undefined") l[0] = "";
        if(typeof l[1] === "undefined") l[1] = [""];
        l[1] = l[1].join("");
        return {
            type: "NumericLiteral",
            value: parseInt(l.join(""))
        }
    }
  ...
  NONLOCAL = "nonlocal" ' '* { return "nonlocal" }
